...
public class ListaTipo {
    ...
    /**
     * Cabeça da tail.
     * @return a cabeça dessa tail de tipos, representada por um Tipo.
     */
    public Tipo head() {
        return tipo;
    }
     ...
     * @return representação textual dessa tail de tipos.
     */
     ...
     * @return todo o conteúdo da tail.
     */
