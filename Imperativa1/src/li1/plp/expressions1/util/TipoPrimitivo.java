...
public enum TipoPrimitivo implements Tipo {
	...
	/* (non-Javadoc)
	 * @see li1.plp.expressions1.util.Tipo#getNome()
	 */
	...
	/* (non-Javadoc)
	 * @see li1.plp.expressions1.util.Tipo#eInteiro()
	 */
	...
	/* (non-Javadoc)
	 * @see li1.plp.expressions1.util.Tipo#eBooleano()
	 */
	...
	/* (non-Javadoc)
	 * @see li1.plp.expressions1.util.Tipo#eString()
	 */
	...
	/* (non-Javadoc)
	 * @see li1.plp.expressions1.util.Tipo#eIgual(li1.plp.expressions1.util.Tipo)
	 */
	...
	/* (non-Javadoc)
	 * @see li1.plp.expressions1.util.Tipo#eValido()
	 */
	...
	/* (non-Javadoc)
	 * @see li1.plp.expressions1.util.Tipo#intersecao(li1.plp.expressions1.util.Tipo)
	 */
