...
import plp.functional3.expression.Aplicacao;
import plp.functional3.expression.ExpDeclaracao;
import plp.functional3.expression.ExpMaiorQue;
import plp.functional3.expression.ExpMenorQue;
import plp.functional3.expression.ExpMult;
...
public class PartialInstantiatorVisitor {
	...
	public Expressao visit(Expressao exp, AmbienteExecucao ambiente,
		...
		try {
			...
			e.printStackTrace();
			throw new IllegalStateException("Não foi possível executar o método ("
			...
			throw new IllegalStateException("O método visit chamado (" + methodName
	...
	private Method getMethod(String name) throws NoSuchMethodException {
		...
		if ( method == null ) {
			throw new NoSuchMethodException("O método '" + name
