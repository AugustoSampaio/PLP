...
/**
 * Esta classe representa um tipo polimórfico, ou seja, que é válido como
 * qualquer dos tipos da linguagem.
 * 
 * Exemplo: let fun Id x = x in Id(2)
 * 
 * O tipo inferido para "x" será um curinga ("?"). O tipo instanciado será
...
public class TipoPolimorfico implements Tipo {
	...
	/**
	 * O tipo inferido. <code>null</code> até ser inferido.
	...
	/**
	 * Construtor da classe que representa tipo polimórfico.
	 */
	...
	/**
	 * Retorna o tipo inferido por este tipo polimórfico, se estiver válido.
	 * Caso contrário, retorna o próprio tipo polimórfico.
	 * 
	 * @return
	 */
	public Tipo inferir() {
