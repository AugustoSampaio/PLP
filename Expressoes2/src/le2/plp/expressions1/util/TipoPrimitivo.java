...
public enum TipoPrimitivo implements Tipo {
	...
	/* (non-Javadoc)
	 * @see le2.plp.expressions1.util.Tipo#getNome()
	 */
	...
	/* (non-Javadoc)
	 * @see le2.plp.expressions1.util.Tipo#eInteiro()
	 */
	...
	/* (non-Javadoc)
	 * @see le2.plp.expressions1.util.Tipo#eBooleano()
	 */
	...
	/* (non-Javadoc)
	 * @see le2.plp.expressions1.util.Tipo#eString()
	 */
	...
	/* (non-Javadoc)
	 * @see le2.plp.expressions1.util.Tipo#eIgual(le2.plp.expressions1.util.Tipo)
	 */
	...
	/* (non-Javadoc)
	 * @see le2.plp.expressions1.util.Tipo#eValido()
	 */
	...
	/* (non-Javadoc)
	 * @see le2.plp.expressions1.util.Tipo#intersecao(le2.plp.expressions1.util.Tipo)
	 */
