...
public enum TipoPrimitivo implements Tipo {
	...
	/* (non-Javadoc)
	 * @see lf1.plp.expressions1.util.Tipo#eInteiro()
	 */
	...
	/* (non-Javadoc)
	 * @see lf1.plp.expressions1.util.Tipo#eBooleano()
	 */
	...
	/* (non-Javadoc)
	 * @see lf1.plp.expressions1.util.Tipo#eString()
	 */
	...
	/* (non-Javadoc)
	 * @see lf1.plp.expressions1.util.Tipo#eValido()
	 */
