 ...
 * Gerencia o ciclo de vida dos quadros (incrementa/registra/map/restaura)
 * e acumula os QuadroEscopo resultantes.
 */
public class PilhaSnapshot<T> {
	...
	/** Marca a entrada em um novo nível de escopo. Cria o quadro imediatamente. */
	...
	public void registraEscopo(InfoEscopo info) {
		if (!quadrosAtivos.empty() && info != null) {
			...
			QuadroEscopo novo = new QuadroEscopo(info.getEscopo(), info.getTrechoCodigoFonte());
