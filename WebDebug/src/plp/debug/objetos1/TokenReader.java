...
import loo1.plp.orientadaObjetos1.parser.Token;
import plp.debug.core.SourceToken;

/**
 * Relê o código-fonte usando o lexer real de Objetos1 (gerado pelo próprio
...
public final class TokenReader {
	...
	public static List<SourceToken> read(String source) {
		...
		try {
			OO1Parser parser = new OO1Parser(new ByteArrayInputStream(source.getBytes()));
